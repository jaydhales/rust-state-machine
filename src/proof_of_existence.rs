...
impl<T: Config> Pallet<T> {
    ...
    pub fn revoke_claim(&mut self, caller: T::AccountId, claim: T::Content) -> DispatchResult {
            ...
            .eq(&caller)
        {
            ...
            false => Err("Content is not owned by caller"),
        }
    }
}
...
mod test {
    ...
    fn basic_proof_of_existence() {
        ...
        assert_eq!(
            poe.create_claim("alice".to_string(), "Hello, world!".to_string()),
            Ok(())
        );
        assert_eq!(
            poe.get_claim(&"Hello, world!".to_string()),
        ...
        assert_eq!(
            poe.revoke_claim("alice".to_string(), "Hello, world!".to_string()),
            Ok(())
        );
        assert_eq!(
            poe.create_claim("bob".to_string(), "Hello, world!".to_string()),
